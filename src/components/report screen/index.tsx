...
import { Right, Button, Input, Text, Left } from './styled';
    ...
    return (
        <div>
            ...
            <Left>
                ...
                <br />
                <p>Descrição da situação atual</p>
                <br />
                <p>
                    Buraco bem em frente a sorveteria marbella, quase causou 2 acidentes essa semana adsa sdasd as das
                    das das das das das dasdasdsa dasdasas
                </p>
